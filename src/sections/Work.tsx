                ...
                <div className="container">
                    <div className="flex flex-col md:flex-row items-center gap-7">
                        ...
                        <div className="text-white text-md md:text-lg leading-7 md:!leading-8 drop-shadow-lg bg-black/40 p-6 rounded-2xl w-full space-y-3">
                            ...
                            <WorkTitle header="3. Kotlin and Architecture (MVVM) / Project Manager.">
                            ...
                            <WorkTitle header="4. The search for self.">
                            ...
                            <WorkTitle header="5. My first company – Syject.">
                            ...
                            <WorkTitle header="6. War — russia's invasion of Ukraine">
                            ...
                            <WorkTitle header="7. Finding a job in a war environment">
                            ...
                            <WorkTitle header="8. Return to Syject">
