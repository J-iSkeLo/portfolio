    ...
    <div class="lg:px-7" id="portfolio">
        <Section title="Portfolio">
            <div class="container">
                ...
                <!-- Intro -->
                <div
                    class="pt-14 pb-8 text-lg lg:text-xl max-w-5xl mx-auto text-center leading-8 text-gray-600"
                >
                ...
                <!-- Items -->
                <div
                    class="min-h-[450px] grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-6"
                >
