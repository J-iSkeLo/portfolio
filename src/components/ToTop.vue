...
<template>
    <button
        ref="toTopBtn"
        type="button"
        class="fixed bottom-6 right-6 z-20 bg-main p-2 rounded-full shadow-hero opacity-0 transition-all duration-500 hover:scale-110 cursor-pointer"
        @click="goToTopHandler"
        id="to-top"
    >
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" viewBox="0 0 20 20" fill="white">
            <path
                fill-rule="evenodd"
