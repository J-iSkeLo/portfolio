                    ...
                    <div class="flex flex-col md:flex-row w-full pl-5 pr-5 rounded-md border border-dashed border-gray-300 mt-8">
                        ...
                        >
                            <div
                                ...
                                :key="i"
                                class="text-[.8em] flex justify-between relative mb-2 last:mb-0"
                            >
                                <h4 class="uppercase pr-4 bg-white">
                                    {{ item.label }}
                                </h4>
                                <b class="block absolute left-1 right-1 top-1/2 border-b border-dashed border-b-gray-300 -z-10"></b>
                                <h4 class="bg-white pl-4 font-bold text-gray-500">
                                    {{ item.value }}
                                </h4>
                            </div>
                        </section>
