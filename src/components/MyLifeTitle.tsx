    ...
    return (
        <>
            <div
                ...
                className={`flex items-center justify-between gap-3 leading-6 text-sm md:text-md xl:text-xl border px-4 py-2 rounded-lg cursor-pointer transition-colors ${
                    showContent
