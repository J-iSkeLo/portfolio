...
import issaImage from '@/assets/img/reviews/issa.webp'
import kobaImage from '@/assets/img/reviews/koba.webp'
...
const reviews: Review[] = [
    ...
    },
    {
        ...
        review: <p>I was pleasantly surprised by the timing. Instead of the agreed two months, it took only 5 weeks to develop, the application with a tie to the site was ready and working. Thanks for the speed and quality.</p>,
    },
    {
        img: arabicaImage,
        name: 'Sam',
        companyName: 'Arabica',
        review: <p>Dear Alex, you're a good man and a good developer. We do really like you and appreciate you and your work. Thanks for your patience and good work 🤝 We'll miss your music in presentation videos🕺🏼💃🏻</p>,
    },
    {
        img: serhiiImage,
        name: 'Serhii',
    ...
    },
    {
        ...
        review: <p>Nice person and high skilled specialist in Android development.</p>,
    },
    {
        img: kobaImage,
        name: 'Artem Koba',
